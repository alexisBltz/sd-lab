        ...
        for (int i = 0; i < 5; i++) {
            Thread thread = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    System.out.println("Thread " + Thread.currentThread().getId() + " createdevent with Lamport time " + time);
                    try {
                    ...
                    System.out.println("Thread " + Thread.currentThread().getId() + " receivedevent with Lamport time " + receivedTime);
